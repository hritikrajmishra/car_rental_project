            ...
            <div class="col-lg-8">
                <div class="service-details-wrap pl-lg-5">
                    <div class="road-transfort owl-carousel owl-theme">
                        <div class='single-item  active'><img src='/gallery/audiq--5.jpg' alt='Audi Q5 45 TFSI Technology'></div><div class='single-item '><img src='/gallery/audi-q5-.jpg' alt='Audi Q5 45 TFSI Technology'></div><div class='single-item '><img src='/gallery/aud-iq5.jpg' alt='Audi Q5 45 TFSI Technology'></div><div class='single-item '><img src='/gallery/au-diq5.jpg' alt='Audi Q5 45 TFSI Technology'></div><div class='single-item '><img src='/gallery/a-udiq5.jpg' alt='Audi Q5 45 TFSI Technology'></div>							</div>
                    <div class="content">


                        <!--<div class="sec-title ">-->
                        <!--<div class="">Audi Q5 45 TFSI Technology Luxury Car</div>-->
                        <h3>Audi Q5 45 TFSI Technology</h3>
                        <!--</div>-->
                        ...
                        <div class="text">
                            ...
                            <p>Book online luxury cars on rent for weddings, corporate meetings, etc. at Rent My Way. We provide cars on rent in North India. The new Audi Q5 45 TFSI Technology (special edition)luxury car is available at us. Booking is available. We have a wide range of Wedding cars and luxury cars. Book cars on rent.</p>
                            <p>Book online Audi Q5 45 TFSI Technology (special edition)luxury car at affordable prices from Rent My Way. It is the best car.</p>

                            <h4>Key Specifications</h4>
                            <ul>
                                <li><strong>Fuel Type:</strong> Petrol</li>
                                <li><strong>Engine Type:</strong> 4-cylinder in-line petrol</li>
                                <li><strong>Transmission:</strong> Automatic</li>
                                <li><strong>Seating Capacity:</strong> 5Seater</li>
                                <li><strong>Fuel Tank Capacity:</strong> 70L</li>
                                <li><strong>Body Type:</strong> SUV</li>
                            </ul>								</div>
                    </div>
                    <div class="ask-question">
                        <h3>Book Audi Q5 45 TFSI Technology</h3>
                        @include('main.form')
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="service-sidebar-area">
                    <div class="service-list service-card">
                        <h3 class="service-details-title">Luxury Cars</h3>
                        <ul>
                            <li class=''><a href='/luxury-cars/audi-q2/'><i class='bx bx-check'></i> Audi Q2  </a></li><li class=''><a href='/luxury-cars/audi-a6-matrix-edtion-car/'><i class='bx bx-check'></i> Audi A6 Matrix Edtion Car  </a></li><li class='current'><a href='/luxury-cars/audi-q5-45-tfsi-technology/'><i class='bx bx-check'></i> Audi Q5 45 TFSI Technology  </a></li><li class=''><a href='/luxury-cars/audi-q7-car/'><i class='bx bx-check'></i> Audi Q7 Car  </a></li><li class=''><a href='/luxury-cars/mercedes-benz-gls-400d-4matic/'><i class='bx bx-check'></i> Mercedes-Benz GLS 400D 4MATIC  </a></li>								</ul>
                    </div>
                </div>
